...
title: "Electrohydrodynamic Control of Interfacial Films for Advanced Thermal and Fluidic Applications"
order: 4
one_liner: "Engineered electric-field-based methods to control trapped air films during liquid–solid interactions, enabling suppression of bubble entrapment and improved boiling heat transfer for advanced cooling technologies."
image: /assets/img/dielectrophoretic_subfigure.png
caption: "Air-film reconfiguration under spatially periodic dielectrophoretic force."
tags: ["dielectrophoretic,", "electronic cooling, ", "splash suppression, ", "air film entrapment"]
---
...
{% include figure.html 
   src="/assets/img/Cooling.png"
   alt="Electronic cooling platform"
   caption="Figure 1. Cooling enhancement under dielectrophoretic effect. After applying the voltage, temperature of a hot surface reduces from over 145C to below 60C within 800 ms."
%}
...
1.	Q. Vo, and T. Tran, Mediation of Lubricated Air Films using Spatially Periodic Dielectrophoretic Effect, Nature Communications 12, 4289, 2021.
2.	TB Nguyen, Q. Vo, X Shang, F Buang, T Tran, Film Boiling Suppression and Boiling Heat Transfer Enhancement by Dielectrophoretic Effect, Thermal Science and Engineering Progress 40, 101796, 2023.
